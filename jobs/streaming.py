...
def main():
    ...
    print("Wony S3 connection successful.") 
    ...
    print("Schema for Emergency Data:")
    emergencyDF.printSchema()
        
    query1 = streamWriter(vehicleDF, 's3a://wony-spark-data/checkpoints/vehicle-data', 's3a://wony-spark-data/data/vehicle-data')
    query2 = streamWriter(gpsDF, 's3a://wony-spark-data/checkpoints/gps-data', 's3a://wony-spark-data/data/gps-data')
    query3 = streamWriter(trafficDF, 's3a://wony-spark-data/checkpoints/traffic-data', 's3a://wony-spark-data/data/traffic-data')
    query4 = streamWriter(weatherDF, 's3a://wony-spark-data/checkpoints/weather-data', 's3a://wony-spark-data/data/weather-data')
    query5 = streamWriter(emergencyDF, 's3a://wony-spark-data/checkpoints/emergency-data', 's3a://wony-spark-data/data/emergency-data')
